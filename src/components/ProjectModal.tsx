          ...
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              <motion.div
                ...
                className="fixed left-1/2 top-1/2 z-50 w-[95vw] max-w-2xl -translate-x-1/2 -translate-y-1/2 max-h-[90vh] overflow-y-auto rounded-2xl bg-card border border-border shadow-2xl"
